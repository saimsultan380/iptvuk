      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <FadeIn delay={0.15}>
            ...
            >
              Non-expiring credits from £1.20 per credit. Instant panel
              activation. White label branding available. 24/7 reseller support.
              Multi-server infrastructure with 99.9% uptime.
            </p>
          </FadeIn>
