...
const STEPS = [
  {
    number: 1,
    heading: "Step 1 — Request Your Trial",
    body: "Send us your details and the device you plan to use. No payment information needed at any stage of the request.",
  },
  {
    number: 2,
    heading: "Step 2 — Receive Your Login Details",
    body: "Your username, password, and Portal URL arrive by email — usually within a few minutes. This is the same activation process used for full subscriptions, so you are testing the real service, not a limited demo.",
  },
  {
    number: 3,
    heading: "Step 3 — Start Watching",
    body: "Enter your login details into your preferred IPTV app and your trial channel access loads immediately. Explore live channels, sports, and on-demand content for the full 24 hours.",
  },
];
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        <FadeIn delay={0.15}>
          ...
          >
            Three simple steps, and most people are watching within minutes of
            requesting access.
          </p>
        </FadeIn>
