      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <FadeIn delay={0.15}>
            ...
            >
              Every device covered. Every step explained. Support available if
              you need it. Most customers are watching within fifteen minutes
              of starting.
            </p>
          </FadeIn>
          ...
          <ScrollReveal direction="up" delay={0.1} once>
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row md:mt-12">
              ...
              <Link
                href="/subscription-plans#free-trial"
