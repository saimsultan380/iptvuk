    ...
    >
      ...
      <Container className="relative z-10 pt-32 text-center sm:pt-36">
        ...
        <FadeIn delay={0.12}>
          ...
          >
            IPTV Free Trial — Test the Full Service{" "}
            <span style={{ color: "var(--hero-accent)" }}>Free for 24 Hours</span>
          </h1>
        </FadeIn>
        ...
        <FadeIn delay={0.18}>
          ...
          >
            You should not have to take anyone&apos;s word for it. Before you spend
            a penny, claim a free IPTV trial and see the channel quality, the sports
            streams, and the stability for yourself.
          </p>
        </FadeIn>
        ...
        <FadeIn delay={0.22}>
          ...
          >
            ...
            >
              24 hour IPTV free trial UK
            </strong>{" "}
            gives you full access — no card details, no automatic sign-up, no
            obligation to continue. If it is right for you, subscribing takes two
            minutes. If it is not, you walk away with nothing to pay.
          </p>
        </FadeIn>
